...
class LoginController extends Controller
{
    ...
    public function register(Request $request){
        ...
        $user_store->mother_name  = $request->mother_name;
        $user_store->address  = $request->address;
        $user_store->security_question  = $request->security_question;
        $user_store->answer  = $request->answer;
     //   $user_store->invite_code  = $request->invite_code;
    ...
    public function generateAccNo(){
        $rend = rand(100000, 999999). rand(100, 999);
