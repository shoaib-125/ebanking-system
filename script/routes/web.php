...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('search/export/{user_id}/{trans_id}', 'AdminController@exportSearch')->name('search.export');
...
Route::group(['prefix' => 'user', 'as' => 'user.', 'namespace' => 'User', 'middleware' => ['auth','user','verified','verifiedphone']], function () {
    ...
    Route::post('verificationRequest', 'AccountSettingController@verificationRequest')->name('verifyDocs');
