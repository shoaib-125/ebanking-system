...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            @endif
            <form method="POST" action="{{ route('admin.client.freedback.title.update', $client_feedback_title->id) }}" class="basicform">
              @csrf
              @method('put')
              @php
                  $info = json_decode($client_feedback_title->value);
              @endphp
              <div class="card-body">
