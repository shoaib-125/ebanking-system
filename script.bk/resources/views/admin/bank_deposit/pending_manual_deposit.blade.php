...
@section('head')
@include('layouts.backend.partials.headersection',['title'=>'Pending Manual Deposit List'])
@endsection
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-lg-6">
                    <form method="get" action="{{ route('admin.manual_deposit.pending.search') }}">
                      ...
                      <td>
                        ...
                        <div class="dropdown d-inline">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item has-icon approve-confirm" href="{{ route('admin.manual_deposit_view',$deposit->id) }}" ><i class="fa fa-eye"></i>{{ __('View') }}</a>
                            ...
                            <!-- Delete Form -->
                            <form class="d-none" id="delete_form_{{ $deposit->id }}" action="{{ route('admin.manual_deposit.update', $deposit->id) }}" method="POST">
                            @csrf
                            <input type="hidden" value="0" name="type">
                            </form>
                            <form class="d-none" id="approve_form_{{ $deposit->id }}" action="{{ route('admin.manual_deposit.update', $deposit->id) }}" method="POST">
                              @csrf
